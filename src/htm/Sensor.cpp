...
{
	int centerX = Random::Range(8, 24);
	int centerY = Random::Range(8, 24);
	int radius = 8 + Random::Range(10);
...
void Sensor::FormImage(QDir dir, int sensorId)
{
	...
	sensorImage.save(dir.absoluteFilePath("synapse_" + QString("%1").arg(sensorId, 4, 10, QChar('0')) + ".png"));
}
